/// Implementation from https://github.com/gnosis/ethcontract-rs/blob/main/ethcontract/src/int.rs
use crate::abi::{InvalidOutputType, Token, Tokenizable, TokenizableItem};
...
mod tests {
    ...
    #[test]
    fn parse_dec_str() {
        let min_abs: U256 = U256::from(1) << 255;
